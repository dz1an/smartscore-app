# Generated by Django 4.2.16 on 2024-11-15 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_id', models.CharField(blank=True, editable=False, max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_id', models.CharField(blank=True, max_length=6, unique=True)),
                ('class_assigned', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exams', to='smartscoreapp.class')),
                ('questions', models.ManyToManyField(related_name='exams', to='smartscoreapp.question')),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_id', models.CharField(blank=True, max_length=5)),
                ...
                ('questions', models.ManyToManyField(blank=True, related_name='test_sets', to='smartscoreapp.question')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='smartscoreapp.student')),
            ],
            options={
